...
function Items() {
  ...
  useEffect(() => {
    if (searchQuery.trim() === "") {
      ...
      setFilteredClothing(
        clothing.filter(item => item.description.toLowerCase().includes(searchQuery.toLowerCase()))
      );
    }
  ...
  return (
    <>
      ...
      <div className="container mx-auto mb-10">
        ...
        {filteredClothing.length === 0 && !error && <p className="text-gray-500">No clothing items found</p>}

        <div className="w-full grid grid-cols-2 xl:grid-cols-5 lg:grid-cols-4 xl:pl-6 pl-1 pr-1
